...
var About = function About() {
  return __jsx("section", {
    ...
    sm: "8",
    md: "6",
    className: "counters m-auto m-b-20",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 16,
  ...
  }, "Muchos clientes quieren comprar un producto inmediatamente, y no esperar a que alguien les responda el chat y env\xEDe links de pago.")), __jsx("p", {
    className: "about-para",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
  ...
  }, "Los rubros de: Moda, Electr\xF3nica, Juguetes, Muebles, Videojuegos, M\xFAsica, Viajes y Turismo mueven $1,5 billones en Tiendas Online!")), __jsx("p", {
    className: "about-para",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=ecommerce.js.f3f81de334b93192a66b.hot-update.js.map