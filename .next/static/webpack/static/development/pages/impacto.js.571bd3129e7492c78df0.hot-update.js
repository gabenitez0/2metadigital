...
var _this = undefined,
    _jsxFileName = "F:\\backup2\\web\\2metadigital\\unice\\pages\\layouts\\sections\\enterprice-sass\\historia.js";
...
var Business = function Business() {
  ...
  }, "En este 2022 estoy enfocado principalmente a este proyecto llamado 2metadigital, el cual inici\xE9 hace aproximadamente 2 a\xF1os, y en todo este tiempo aprend\xED como transformar los servicios que brindo para realmente solucionar las necesidades de mis clientes."))))), __jsx("div", {
    className: "offers-content",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
  ...
  }, "Sobre mi proyecto 2MetaDigital:"))), __jsx("p", {
    className: "offer-sub-text ",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
  ...
  }, "2MetaDigital empez\xF3 hace 2 a\xF1os (con otro nombre) y solo se enfocaba en eCommerces. En todo este tiempo conseguimos ampliar la gama de soluciones y perfeccionar nuestros servicios no solo en cuanto a solucionar problemas sino tambi\xE9n en cuanto a los costos de tiempo por trabajo, es decir que podemos entregar productos terminados en poco tiempo.")))))), __jsx(reactstrap__WEBPACK_IMPORTED_MODULE_2__["Col"], {
    lg: "4",
    sm: "6",
    className: "m-auto",
    __self: _this,
...
//# sourceMappingURL=impacto.js.571bd3129e7492c78df0.hot-update.js.map