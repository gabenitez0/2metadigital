...
var _this = undefined,
    _jsxFileName = "F:\\backup2\\web\\portfolio\\unice\\containers\\common\\nav.js";
...
var Nav = function Nav() {
  ...
  return __jsx("div", {
    ...
    return __jsx("li", {
    ...
    }, menuItem.sidebartitle) : '', menuItem.type === 'sub' ? __jsx(next_link__WEBPACK_IMPORTED_MODULE_1___default.a, {
      className: "dropdown",
      href: menuItem.link,
      ...
      return __jsx("div", {
        className: "".concat(menuItem.megaMenuType == 'mini' ? 'col-lg-6' : menuItem.megaMenuType == 'small' ? 'col-lg-4' : menuItem.megaMenuType == 'medium' ? 'col-lg-3' : menuItem.megaMenuType == 'large' ? 'col' : '', " "),
        key: i,
        __self: _this,
        __source: {
          fileName: _jsxFileName,
      ...
      }, menuItem.title === 'Inicio' ? megaMenuItem.children.map(function (subMegaMenuItem, i) {
        return __jsx("li", {
          key: i,
          __self: _this,
          __source: {
...
//# sourceMappingURL=index.js.e1a32dc03c11ecbd5bc7.hot-update.js.map