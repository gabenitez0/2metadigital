...
module.exports = {
  ...
  ContentData: [{
    ...
    details: 'Puedes utilizar la forma y el medio de publicidad que quieras y te resulte eficiente. Cualquier medio como TikTok, Instagram, Facebook, Twitter, etc. y cualquier forma como SEO (Orgánico), SEM (Anuncios), P2P (Contacto Directo), etc.'
  }, {
    ...
    details: 'Cuando le avises al desarrollador que concretaste una venta éste te enviará tu comisión automáticamente. Las comisiones van desde $60 USD hasta +$350 USD por Cada Venta dependiendo del producto que el cliente compre, incluso puedes ganar más de 350 USD si el cliente compra varios productos. Esto corresponde al más del 40% del valor total de la compra.'
  }]
};
...
//# sourceMappingURL=afiliados.js.bf37a13cebb0fda21a3d.hot-update.js.map