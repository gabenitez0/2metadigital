...
module.exports = {
  ...
  ContentData: [{
    ...
    details: 'Utilizando la Información para Afiliados de nuestros productos y servicios con sus correspondientes precios, debes cerrar la venta con el cliente, incluyendo el pago que debe llegar a la cuenta de 2metadigital.',
    button: 'Información para Afiliados'
  }, {
    img: '/assets/images/saas1/tab/Security.png',
    title: '4. Reclamar Comisión',
    desc: 'Recibirás tus comisiones automáticamente',
    details: 'De esta forma podemos estar en contacto directo vendedor -> desarrollador.'
  }]
};
...
//# sourceMappingURL=afiliados.js.7ce8edd9e513910618f6.hot-update.js.map